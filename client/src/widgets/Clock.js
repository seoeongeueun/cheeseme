...
function Clock({ move, userId }) {
  ...
  useEffect(() => {
    if (userId) {
      instance
        .get('/api/clock/getByOwner/' + userId, {
  ...
  return (
    <div className="clockWidget">
      ...
      {(my || ny || kor || bei || par || van) && (
        <div className="clockWidgetTitle">
          ...
          <div className="settingMode">
            {settings ? (
              <ExpandLessRoundedIcon
                sx={{ fontSize: '3rem', marginTop: '1rem', color: '#78d2fa' }}
        ...
        <div className="clocks">
          ...
          {ny && (
            <div className="timeZone">
              ...
              <div className="timeDate">
                <span>
                  {nyDate.getMonth() + 1}/{nyDate.getDate()}
                </span>
                <span style={{ marginLeft: '5px' }}>
                  {weekday[nyDate.getDay()]}
                </span>
              </div>
            </div>
          )}
          {kor && (
            <div className="timeZone">
              ...
              <div className="timeDate">
                <span>
                  {korDate.getMonth() + 1}/{korDate.getDate()}
                </span>
                <span style={{ marginLeft: '5px' }}>
                  {weekday[korDate.getDay()]}
                </span>
              </div>
            </div>
          )}
          {van && (
            <div className="timeZone">
              ...
              <div className="timeDate">
                <span>
                  {vanDate.getMonth() + 1}/{vanDate.getDate()}
                </span>
                <span style={{ marginLeft: '5px' }}>
                  {weekday[vanDate.getDay()]}
                </span>
              </div>
            </div>
          )}
          {bei && (
            <div className="timeZone">
              ...
              <div className="timeDate">
                <span>
                  {beiDate.getMonth() + 1}/{beiDate.getDate()}
                </span>
                <span style={{ marginLeft: '5px' }}>
                  {weekday[beiDate.getDay()]}
                </span>
              </div>
            </div>
          )}
          {par && (
            <div className="timeZone">
              ...
              <div className="timeDate">
                <span>
                  {parDate.getMonth() + 1}/{parDate.getDate()}
                </span>
                <span style={{ marginLeft: '5px' }}>
                  {weekday[parDate.getDay()]}
                </span>
              </div>
            </div>
          )}
      ...
      {settings && (
        <div className="countries" style={{ marginTop: '0.8rem' }}>
          <div className={my ? 'country' : 'countryOff'}>
            <button
              onClick={userId ? () => handleCountryClick(0) : () => setMy(!my)}
            >
              <img src={Cheese} alt="cheese" />
              <span>MY TIME</span>
            </button>
          ...
          <div className={ny ? 'country' : 'countryOff'}>
            <button
              onClick={userId ? () => handleCountryClick(1) : () => setNy(!ny)}
            >
          ...
          <div className={kor ? 'country' : 'countryOff'}>
            <button
              onClick={
                userId ? () => handleCountryClick(2) : () => setKor(!kor)
              }
            >
      ...
      {settings && (
        <div className="countries">
          <div className={van ? 'country' : 'countryOff'}>
            <button
              onClick={
                userId ? () => handleCountryClick(3) : () => setVan(!van)
              }
            >
          ...
          <div className={bei ? 'country' : 'countryOff'}>
            <button
              onClick={
                userId ? () => handleCountryClick(4) : () => setBei(!bei)
              }
            >
          ...
          <div className={par ? 'country' : 'countryOff'}>
            <button
              onClick={
                userId ? () => handleCountryClick(5) : () => setPar(!par)
              }
            >
