    ...
    <div className="settingsboxHeader">
      <div className="friendHeader">
        ...
        <div className="friendButton">
          <button
            disabled={userId ? (removeFriend ? true : false) : true}
            className={
              userId ? (removeFriend ? 'cancel2' : 'save2') : 'cancel2'
            }
          ...
          {removeFriend ? (
            <button className="save2" onClick={() => setRemoveFriend(false)}>
              <span>
          ...
          <div className="friendList">
            {friends.map((f, i) => (
              <div className="friendItem" key={i}>
                <img
                  src={f.fav ? StarColor : Star}
                  style={{
                    width: '1rem',
                    marginRight: '0.5rem',
                    marginTop: '3px',
                  }}
                  onClick={() => handleStar(f.name)}
                />
