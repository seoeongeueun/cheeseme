...
export default function Signup(props) {
  ...
  React.useEffect(() => {
    if (errorType === 'noPw' || errorType === 'noPwCheck' || errorType === 'shortPw' || errorType === 'notMatch'){
      setErrorType('');
    }
  }, [pw, checkPw])
    ...
    <div>
      <Dialog open={open} onClose={handleClose} style={{border: '1px solid black', borderRadius: '5px'}}>
        <div className='muiModal'>
          ...
          <div className='dialogContent'>
            <span>Enter your email. This will be used to find your password later.</span>
          ...
          <div className='dialogContent'>
            ...
            <input type='password' className='dialogInput' placeholder='password' onChange={(e) => setCheckPw(e.target.value)} minLength="6" maxLength="12" required></input>
          </div>
