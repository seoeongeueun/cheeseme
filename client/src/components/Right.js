...
function Right({ date, userId, friendId, onSetFriendId, onChangeDate, name }) {
  ...
  useEffect(() => {
    if (userId) {
      instance
        .get('/api/right/getByOwner/' + userId, {
  ...
  useEffect(() => {
    if (friendId !== '' && friendId !== undefined && userId) {
      instance
        .get('/api/right/getByOwner/' + friendId, {
          withCredentials: true,
        })
        .then((res) => {
          const n = res?.data;
      ...
      {grid ? (
        ...
        >
          <div className="rightContent">
            {friendId === '' && !openBookmark ? (
              <div className="marker">
                <span>
                  <HomeSharpIcon sx={{ fontSize: '1.7rem' }} />
                </span>
              </div>
            ) : (
              <div
                ...
                style={{ top: '6rem', background: 'rgba(249, 216, 118, 0.8)' }}
              >
                <span>
                  <HomeSharpIcon sx={{ fontSize: '1.7rem' }} />
                </span>
            ...
            {friendId !== '' && currentFriendName !== '' ? (
              <div
                className="marker"
                style={{ top: '12rem', background: 'rgba(249, 216, 118, 0.8)' }}
              >
                <span>
                  <PeopleRoundedIcon style={{ fontSize: '1.7rem' }} />
                </span>
              </div>
            ) : (
            ...
            {showBookMark ? (
              <div className="marker4">
                <span>
                  <BookmarkIcon sx={{ fontSize: '1.7rem' }} />
                </span>
              </div>
            ) : (
              <div
            ...
            {openBookmark ? (
              ...
              <div
                className="rightBodyAndHeader"
                style={{ height: edit && '100% !important' }}
              >
                {edit ? (
                ...
                <div
                  className="rightBody"
                  style={{
                    maxHeight: plain && edit && '90%',
                    justifyContent: plain && !edit && 'flex-start',
                  }}
                >
                  <div
                    className="rightBodyHeader"
                    style={{
                      margin: title !== '' && !edit && '0.1rem 0 0.5rem 0',
                    }}
                  >
                    <span>
                    ...
                    <div className="weatherMood">
                      <button
                        ...
                        disabled={friendId !== '' || !edit ? true : false}
                      >
                        <img
                          alt="sunny"
                          src={weather === 'sunny' ? SunColor : SunPlain}
                        />
                      </button>
                      <button
                        style={{ cursor: edit && 'pointer' }}
                      ...
                      >
                        <img
                          alt="cloud"
                          src={weather === 'cloud' ? CloudColor : CloudPlain}
                        />
                      </button>
                      <button
                        style={{ cursor: edit && 'pointer' }}
                      ...
                      >
                        <img
                          alt="rainy"
                          src={weather === 'rainy' ? UmbColor : UmbPlain}
                        />
                      </button>
                      <button
                        style={{ cursor: edit && 'pointer' }}
                        onClick={() => handleWeather('snowy')}
                        disabled={friendId !== '' || !edit ? true : false}
                      >
                        <img
                          alt="snowy"
                          src={weather === 'snowy' ? SnowColor : SnowPlain}
                        />
                      </button>
                    </div>
                  </div>
                      ...
                      {!closeQuill ? (
                        ...
                        >
                          <div className="postButtonsLeft">
                            ...
                            >
                              {bookmark ? (
                                ...
                                <BookmarkBorderOutlinedIcon
                                  sx={{ fontSize: '2.3rem', color: '#000000' }}
                                />
                              )}
                            </button>
                            ...
                            {friendId === '' ? (
                              <button onClick={onClickLock} className="tooltip">
                                {hide ? (
                                  ...
                                  <span className="tooltiptext">
                                    Your friends can view this post
                                  </span>
                                )}
                                {hide ? (
                                  <LockTwoToneIcon
                              ...
                              <button disabled={true} className="tooltip">
                                <LockOpenRoundedIcon
                                  sx={{ fontSize: '2.3rem', color: '#000000' }}
                                />
                              </button>
                          ...
                          <div className="postButtonsRight">
                            <button
                              ...
                              disabled={friendId !== '' ? true : false}
                            >
                              <CreateOutlinedIcon sx={{ fontSize: '2.3rem' }} />
                            </button>
                            <button
                            ...
                            >
                              <div className="muiModal">
                                ...
                                <div className="dialogContent">
                                  <span style={{ marginBottom: '1.2rem' }}>
                            ...
                            <div className="leftWidget">
                              ...
                              >
                                <span className="tooltiptext">
                                  Settings apply separately for each post
                                </span>
                                {showSettings ? (
                                  <SettingsTwoToneIcon
                                    sx={{
            ...
            {!edit && !openBookmark && (
              <div className="rightFooter">
                <div className="pageSlider">
                  <Box sx={{ width: '100%' }}>
                    <Stack
                      className="pageSliderStack"
                      spacing={2}
                      direction="row"
                      sx={{ mb: 1 }}
                      alignItems="center"
                    >
                      <span style={{ marginBottom: '-1.3rem' }}>
                        {allPosts?.length < 1 ? 0 : 1}
                      </span>
                      <Slider
                        aria-label="Posts"
                        key={`slider-${value}`}
                        min={0}
                        max={allPosts?.length - 1}
                        defaultValue={value}
                      ...
                      />
                      <span style={{ marginBottom: '-2.2rem' }}>
                        {allPosts?.length}
                      </span>
                    </Stack>
                  </Box>
                ...
                <div className="pageSliderButtons">
                  ...
                  >
                    <ArrowBackIosNewRoundedIcon sx={{ fontSize: '1.7rem' }} />
                  </button>
                  ...
                  <button
                    onClick={() => {
                      value >= allPosts?.length - 1 || value === -1
                        ? moveDate()
                        : setValue(value + 1);
                    }}
                  >
                    <ArrowForwardIosRoundedIcon sx={{ fontSize: '1.7rem' }} />
                  </button>
                </div>
              </div>
            )}
