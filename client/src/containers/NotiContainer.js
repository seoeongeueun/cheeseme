...
function NotiContainer() {
    ...
    return <Notification name={name} notis={notis} userId={userId} friends={friends}
        onChangeNotis={onChangeNotis} onAddNoti={onAddNoti} onToggleNoti={onToggleNoti}
        onChangeFriends={onChangeFriends} onAddFriend={onAddFriend}/>;
}
